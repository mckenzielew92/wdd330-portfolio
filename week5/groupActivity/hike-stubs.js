...
export default class Hikes {
    ...
    his.parentElement = document.getElementById(elementId);
...
//     //I added this in case I ever need the list of hikes outside of the module. This also sets me up nicely if my data were to move. I can just change this method to the new source and everything will still work if I only access the data through this getter.
//     getAllHikes() {
//         return hikeList;
//     }
...
//         const hikesChildren = Array.from(document.getElementById("hikes"))
